 ...
 */
final class Version20210506221456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE astronaut (id INT AUTO_INCREMENT NOT NULL, agency_id INT DEFAULT NULL, space_station_id INT DEFAULT NULL, id_api INT NOT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, date_of_birth DATE NOT NULL, date_of_death DATE DEFAULT NULL, nationality VARCHAR(255) NOT NULL, twitter VARCHAR(255) DEFAULT NULL, instagram VARCHAR(255) DEFAULT NULL, bio LONGTEXT NOT NULL, profile_img VARCHAR(255) DEFAULT NULL, profile_image_thumbnail VARCHAR(255) DEFAULT NULL, wiki VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_5DADB6E533A13055 (id_api), INDEX IDX_5DADB6E5CDEADB2A (agency_id), INDEX IDX_5DADB6E52722A664 (space_station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
