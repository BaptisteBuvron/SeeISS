...
class PredictSGPSDP
{
    ...
    public function SGP4(PredictSat $sat, $tsince)
    {
        /* Initialization */
    ...
    /* are vector_t structures returning ECI satellite position and */
    /* velocity. Use Convert_Sat_State() to convert to km and km/s. */
    public function SDP4(PredictSat $sat, $tsince)
    {
        /* Initialization */
    ...
    public function Deep($ientry, PredictSat $sat)
    {
        switch ($ientry) {
        case self::dpinit : /* Entrance for deep space initialization */
            $sat->dps->thgr = PredictTime::ThetaG($sat->tle->epoch, $sat->deep_arg);
            $eq = $sat->tle->eo;
     ...
     * Singleton
     *
     * @param PredictSat $sat The current satellite data instance
     *
     * @return PredictSGPSDP
     */
    public static function getInstance(PredictSat $sat)
    {
